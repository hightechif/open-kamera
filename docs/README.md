...
| #  | Document                                                                                  | What You'll Learn                                                                     |
|----|-------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------|
| 01 | [Camera API Overview](./module-01-foundations/01-camera-api-overview.md)                  | Camera1 vs Camera2, why Camera2 is the default, and when the Camera1 fallback is used |
