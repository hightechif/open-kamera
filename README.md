...
- **Video recording** with MediaRecorder, codec selection, and A/V sync
- **Advanced patterns** — reactive metadata flows, HUD rendering, device quirks, and clean architecture

👉 **[Start learning → docs/README.md](docs/README.md)**
